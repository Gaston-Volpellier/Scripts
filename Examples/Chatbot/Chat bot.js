...
try {
  ...
  const chatClose = function (elt) {
    ...
    btnClose.addEventListener("click", function (evt) {
      ...
      const ga0 = ga.getAll ? ga.getAll()[0] : "undefined";
      if (typeof ga0 !== "undefined") {
        ga0.send(
          "event",
          "DY Smart Action",
          tagName,
          experienceName + " (" + variationName + " - chat_closed)",
          { nonInteraction: true }
        );
      }
    });
    ...
    if (typeof ga !== "undefined") {
      ...
      if (typeof ga0 !== "undefined") {
        ga0.send(
          ...
          "DY Smart Action",
          tagName,
          experienceName + " (" + variationName + " - chat_impression)",
          { nonInteraction: true }
        );
      }
    }
      ...
      if (typeof ga !== "undefined") {
        ...
        if (typeof ga0 !== "undefined") {
          ga0.send(
            ...
            "DY Smart Action",
            tagName,
            experienceName + " (" + variationName + " - chat_opened)",
            { nonInteraction: true }
          );
        }
      }
