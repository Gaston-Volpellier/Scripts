...
function createPopinElt(useFullscreenPopin) {
  ...
  if (useFullscreenPopin === "yes") {
    ...
    firstContent.classList.add("dy-font--xlarge", "l-vmargin--medium");
  }

  mainContent = createElt(
    "div",
    { class: "l-vmargin--medium fs--medium" },
    "${Content}"
  );
  ...
  btn1 = createElt("a", {
    class:
      "text-black btn--xsmall fs--medium l-hmargin--large btn-cta ff-normal",
    href: "${Link Button 1}",
  });
  btn1Span = createElt(
    "span",
  ...
  btn2 = createElt("a", {
    class:
      "text-black btn--xsmall text-white fs--medium l-hmargin--large btn-cta ff-normal",
    href: "${Link Button 2}",
  });
  btn2Span = createElt(
    "span",
