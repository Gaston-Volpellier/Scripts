...
//   },
//   nl: {
//     text: "EEN CHAT STARTEN",
//   },
//   de: {
//     text: "STARTEN SIE EINEN CHAT",
//   },
//   it: {
//     text: "INZIA UNA CONVERSAZIONE",
//   },
//   pt: {
//     text: "INICIAR UMA CONVERSA",
//   },
//   es: {
...
const init = () => {
  ...
  if (container) {
    ...
    console.log("DY | CTA countryData", countryData);
    console.log("DY | CTA country", country);
    console.log("DY | CTA ctaText", ctaText);
    console.log("DY | CTA text", ctaText[country].text);
